...
namespace PlayWay.Water
{
	...
	public class WaterOverlays
	{
		...
		public WaterOverlays(WaterCamera camera, int resolution)
		{
			...
			slopeMap = new RenderTexture(resolution, resolution, 0, RenderTextureFormat.ARGBHalf, RenderTextureReadWrite.Linear);
		...
		/// <summary>
		/// RGB = XYZ displacement, W = shoreline mask
		/// </summary>
